...
public class DBTools{
	...
	public static String sanitize(String s) {
		...
		if(s.matches(".*[^\\w]+.*")) {
			JOptionPane.showMessageDialog(null, "Your event name contains potentially malicious characters."+Processing.getLineSep()+"It has been changed from '" + s +"' to '"+san+"'", "Security alert", JOptionPane.INFORMATION_MESSAGE);
		}
		return san;
	}
}